                ...
                <div className=''>
                    <button
                        ...
                        className={choice === true ?
                            'w-full p-2 sm:p-6 md:p-14 lg:p-24 text-center text-xs md:text-sm lg:text-4xl text-th-primary-light rounded-lg bg-opacity-100 bg-th-accent-success focus:outline-none transition duration-300 ease-in-out'
                            : 'w-full p-2 sm:p-6 md:p-14 lg:p-24 text-center ring-2 lg:ring-4 ring-th-accent-success text-xs md:text-sm lg:text-4xl text-th-primary-light rounded-lg bg-opacity-0 focus:outline-none transition duration-300 ease-in-out'
                        }
                    >
                        Mooning
                    </button>
